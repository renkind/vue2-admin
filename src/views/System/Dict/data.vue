		...
		<el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				...
				<el-form-item label="显示排序" prop="orderNum">
					<el-input-number v-model="form.orderNum" controls-position="right" :min="1" :max="999" />
				</el-form-item>
...
<script>
import { listData, getData, delData, addData, updateData } from "@/service/dict/data";
import { listType, getType } from "@/service/dict/type";
			...
			this.$refs["form"].validate(async (valid) => {
				if (valid) {
					if (this.form.dictCode !== undefined) {
						...
						const res = await addData(this.form);
						if (res.code === 200) {
