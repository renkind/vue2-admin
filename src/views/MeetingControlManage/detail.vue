<template>
	<div class="edit-continer">
		...
		<div class="content" v-loading="loading">
			<el-form ref="dialogForm" :model="dialogForm" label-width="100px" style="margin-bottom: 10px">
				...
				<el-form-item label="通知内容" class="jContent">
					<p v-html="dialogForm.content" class="conClass"></p>
				</el-form-item>
			</el-form>
		</div>
	...
	methods: {
		async getNotice() {
			...
			if (res.code === 200) {
				...
				this.detailArr = [{ label: "通知名称", value: this.dialogForm.name, type: "text" }];
